...
sed -i -e 's/(25001)/(25006)/g' ./config.txt
...
do
	...
	# Launch the ros file
	roslaunch flightcontroller fly.launch port:="25006" test_location:="$current_dir" save_location:="$current_dir" &
