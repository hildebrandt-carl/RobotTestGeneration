...
ROS_MASTER_URI=http://localhost:11318
...
sed -i -e 's/(25001)/(25008)/g' ./config.txt
...
do
	...
	# Launch the ros file
	roslaunch flightcontroller fly.launch port:="25008" test_location:="$current_dir" save_location:="$current_dir" &
