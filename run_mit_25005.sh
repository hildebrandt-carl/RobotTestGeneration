...
sed -i -e 's/(25001)/(25005)/g' ./config.txt
...
do
	...
	# Launch the ros file
	roslaunch flightcontroller fly.launch port:="25005" test_location:="$current_dir" save_location:="$current_dir" &
