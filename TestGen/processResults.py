...
beams = [1, 2, 3, 4, 5, 10, 25, 50, 100]
depths = [10]

for beam in beams:
    for depth in depths:

        file_location = "./Results/FullRun-08-13-19/nodes1000_res4/MIT_seed10_depth" + str(depth) + "_nodes1000_res4_beamwidth" + str(beam) + "_baseline0/"
