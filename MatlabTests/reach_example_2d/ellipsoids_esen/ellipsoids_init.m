...
%
  ...
  ellOptions.time_grid          = 200; %200;   % density of the time grid
  ...
  ellOptions.plot2d_grid = 200; %200; % grid density for plotting in 2D
  ellOptions.plot3d_grid = 200; %200; % grid density for plotting in 3D
